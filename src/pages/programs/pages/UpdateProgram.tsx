...
const UpdateProgram = () => {
  ...
  const { id } = useParams();
  const { loading, program, notFound, superUserGetsProgram } =
    useSuperUserGetsProgram();
  const navigate = useNavigate();

  const { loading: loadingUpdateProgram, superUserUpdatesProgram } =
    useSuperUserUpdatesProgram();
