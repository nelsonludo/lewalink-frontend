      ...
      <div className="container mx-auto px-4 py-16 flex flex-col-reverse lg:flex-row items-center gap-8">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          <p className="text-gray-600 mt-4 text-lg">
            Finding the perfect school has never been easier. From primary to
            secondary schools, and universities, we simplify the journey to help
            you find the best educational fit for you or your child.
          </p>
